...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']("/", "fonts", true, true);
   ...
   loadPackage({"files": [{"filename": "/fonts/Cousine-Regular.ttf", "start": 0, "end": 43912, "audio": 0}, {"filename": "/fonts/DroidSans.ttf", "start": 43912, "end": 233956, "audio": 0}, {"filename": "/fonts/Karla-Regular.ttf", "start": 233956, "end": 250804, "audio": 0}, {"filename": "/fonts/ProggyClean.ttf", "start": 250804, "end": 292012, "audio": 0}, {"filename": "/fonts/ProggyTiny.ttf", "start": 292012, "end": 327668, "audio": 0}, {"filename": "/fonts/Roboto-Medium.ttf", "start": 327668, "end": 490256, "audio": 0}, {"filename": "/galaxie2.jpg", "start": 490256, "end": 873239, "audio": 0}], "remote_package_size": 873239, "package_uuid": "c1031ce5-195c-410a-b261-c2cf1171a3d8"});
...
var ASM_CONSTS = {
 ...
 175075: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 176064: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 176157: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 176226: function() {return screen.width;},  
 176251: function() {return screen.height;},  
 176277: function() {return window.innerWidth;},  
 176307: function() {return window.innerHeight;},  
 176338: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 176433: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 176570: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 176794: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 177287: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
